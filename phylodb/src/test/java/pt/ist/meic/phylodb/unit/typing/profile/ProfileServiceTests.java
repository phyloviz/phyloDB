...
public class ProfileServiceTests extends ServiceTestsContext {
	...
	private static Stream<Arguments> saveAll_params() throws IOException {
		...
		MultipartFile fileNone = createFile("formatters/ml", "ml-d-0.txt"), file1 = createFile("formatters/ml", "ml-h-d-1.txt"),
				fileN = createFile("formatters/ml", "ml-h-d-2-m.txt"), fileNBad = createFile("formatters/ml", "ml-h-d-2-d.txt");
