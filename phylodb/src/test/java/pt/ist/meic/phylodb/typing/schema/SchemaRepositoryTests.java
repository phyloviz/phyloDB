...
public class SchemaRepositoryTests extends RepositoryTests {
	...
	private static Stream<Arguments> findAll_params() {
		...
		List<Entity<String>> loci1 = Arrays.asList(new Entity<>(locus1.getPrimaryKey().getId(), locus1.getVersion(), locus1.isDeprecated()),
				new Entity<>(locus2.getPrimaryKey().getId(), locus2.getVersion(), locus2.isDeprecated()));
		List<Entity<String>> loci2 = Arrays.asList(new Entity<>(locus2.getPrimaryKey().getId(), locus2.getVersion(), locus2.isDeprecated()),
				new Entity<>(locus1.getPrimaryKey().getId(), locus1.getVersion(), locus1.isDeprecated()));
	...
	private static Stream<Arguments> find_params() {
		...
		List<Entity<String>> loci1 = Arrays.asList(new Entity<>(locus1.getPrimaryKey().getId(), locus1.getVersion(), locus1.isDeprecated()),
				new Entity<>(locus2.getPrimaryKey().getId(), locus2.getVersion(), locus2.isDeprecated()));
		List<Entity<String>> loci1Changed = Arrays.asList(new Entity<>(locus2.getPrimaryKey().getId(), locus2.getVersion(), locus2.isDeprecated()),
				new Entity<>(locus1.getPrimaryKey().getId(), locus1.getVersion(), locus1.isDeprecated()));
		List<Entity<String>> loci2 = Collections.singletonList(new Entity<>(locus1.getPrimaryKey().getId(), locus1.getVersion(), locus1.isDeprecated()));
		List<Entity<String>> loci2Changed = Collections.singletonList(new Entity<>(locus2.getPrimaryKey().getId(), locus2.getVersion(), locus2.isDeprecated()));
	...
	private static Stream<Arguments> save_params() {
		...
		List<Entity<String>> loci2 = Arrays.asList(new Entity<>(locus2.getPrimaryKey().getId(), locus2.getVersion(), locus2.isDeprecated()),
				new Entity<>(locus1.getPrimaryKey().getId(), locus1.getVersion(), locus1.isDeprecated()));
		List<Entity<String>> loci3 = Collections.singletonList(new Entity<>(locus2.getPrimaryKey().getId(), locus2.getVersion(), locus2.isDeprecated()));
		Schema schema1 = new Schema(key.getTaxonId(), key.getId(), 1, false, Method.MLST, "description", loci1),
	...
	private static Stream<Arguments> findByLoci_params() {
		String[] existentLoci = state[0].getLociIds().stream().map(Entity::getPrimaryKey).toArray(String[]::new),
				loci1NotExists = new String[] {"not", "exists"};
		Schema schema = new Schema(taxon.getPrimaryKey(), "3three", 1, false, Method.SNP, null,
				Collections.singletonList(new Entity<>(locus2.getPrimaryKey().getId(), locus2.getVersion(), locus2.isDeprecated())));
	...
	private static Stream<Arguments> findByDataset_params() {
		...
		List<Entity<String>> loci1 = Arrays.asList(new Entity<>(locus1.getPrimaryKey().getId(), locus1.getVersion(), locus1.isDeprecated()),
				new Entity<>(locus2.getPrimaryKey().getId(), locus2.getVersion(), locus2.isDeprecated())),
				loci2 = Collections.singletonList(new Entity<>(locus2.getPrimaryKey().getId(), locus2.getVersion(), locus2.isDeprecated()));
