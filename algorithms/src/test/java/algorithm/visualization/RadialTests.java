...
public class RadialTests {
	...
	public void compute_1Edges() {
		Coordinate[] coordinates = new Coordinate[]{new Coordinate(PROFILE1_ID, 0, 0), new Coordinate(PROFILE2_ID, -210, 2.5717582782094416e-14)};
		Vertex child = vertex(PROFILE2_ID, 2);
		Vertex root = vertex(PROFILE1_ID, 0, child);
		Visualization visualization = radial.compute(root);
	...
	public void compute_nEdges1Root() {
		Coordinate[] coordinates = new Coordinate[]{
				new Coordinate(PROFILE1_ID, 0, 0), new Coordinate(PROFILE2_ID, -210, 2.5717582782094416e-14),
				new Coordinate(PROFILE3_ID, -520, 6.368163355566237e-14)
		};
	...
	public void compute_nEdgesNTree() {
		Coordinate[] coordinates = new Coordinate[]{
			new Coordinate(PROFILE1_ID,  0, 0), new Coordinate(PROFILE2_ID, 105.00000000000003, 181.8653347947321),
			new Coordinate(PROFILE3_ID, 260.00000000000006, 450.33320996790803), new Coordinate(PROFILE4_ID, -255.00000000000023, -441.6729559300636),
			new Coordinate(PROFILE5_ID, -365.0000000000002, -441.6729559300636), new Coordinate(PROFILE6_ID, -200.00000000000028, -536.9357503463519)
		};
